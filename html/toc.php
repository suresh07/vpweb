...
echo "<div class=\"archive_title\">ಸಂಚಿಕೆ <span class=\"eng\">(".intval($issue).")</span> - ".$nom[$month-1]."<br />ಸಂಪುಟ <span class=\"eng\">(".intval($volume).")</span> - <span class=\"eng\">$year</span></div>";
